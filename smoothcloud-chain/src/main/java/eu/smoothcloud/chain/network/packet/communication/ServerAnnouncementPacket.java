...
package eu.smoothcloud.chain.network.packet.communication;

import eu.smoothcloud.chain.network.packet.SmoothPacket;
import io.netty5.buffer.Buffer;

public class ServerAnnouncementPacket extends SmoothPacket {

    public final static int PACKET_TYPE = 403;
