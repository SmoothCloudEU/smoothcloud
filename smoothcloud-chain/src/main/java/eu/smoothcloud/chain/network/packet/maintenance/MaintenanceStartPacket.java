...
package eu.smoothcloud.chain.network.packet.maintenance;

import eu.smoothcloud.chain.network.packet.SmoothPacket;
import io.netty5.buffer.Buffer;

public class MaintenanceStartPacket extends SmoothPacket {

    public final static int PACKET_TYPE = 1310;
