...
package eu.smoothcloud.chain.network.packet.monitoring;

import eu.smoothcloud.chain.network.packet.SmoothPacket;
import io.netty5.buffer.Buffer;

public class PerformanceMetricsPacket extends SmoothPacket {

    public final static int PACKET_TYPE = 601;
